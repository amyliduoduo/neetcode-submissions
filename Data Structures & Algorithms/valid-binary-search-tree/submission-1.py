...
class Solution:
    def isValidBST(self, root: Optional[TreeNode]) -> bool:
        ...
        return valid(root, float("-inf"), float("inf")) #float("-inf") and float("inf") guarantee that the root always passes the initial check. they represent (-infinity, infinity)
